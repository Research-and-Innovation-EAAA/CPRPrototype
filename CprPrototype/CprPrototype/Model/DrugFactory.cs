...
namespace CprPrototype.Model
{
    ...
    public class DrugFactory
    {
        ...
        public List<Drug> CreateDrugs(double prepTimeMinutes = 5)
        {
            ...
            adrenalinDrug.DosesCollection.Add(new DrugShot(adrenalinDrug, DrugDoseTarget.Adult, "1mg"));
            result.Add(adrenalinDrug);

            // Amiodoran
            var amiodoranDrug = new Drug(DrugType.Amiodaron, prepTime);
            amiodoranDrug.DosesCollection.Add(new DrugShot(amiodoranDrug, DrugDoseTarget.Adult, "300ml"));
            amiodoranDrug.DosesCollection.Add(new DrugShot(amiodoranDrug, DrugDoseTarget.Adult, "150ml"));
